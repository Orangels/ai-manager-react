...
import {PERSONALMESSIONLIST} from "./url_config";
...
export let _fetch = async (url,data,resolve) =>{
  try {
    let response = await fetch(url,{
      method: 'POST',
      // credentials: 'include', //不上传 cookie, 后端 * 匹配 origin
      headers: {
...
export let _GET = async (url, data, resolve) => {
  try{
...
export let _POST = async (url, data, resolve) => {
  try{
