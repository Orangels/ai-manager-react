...
class AppStore {
  ...
  @observable users = [
      {username: 'soeaver', password: 'priv123', auth:0, is_admin: true},
      {username: 'songqing', password: 'priv123', auth:0, is_admin: true},
      {username: 'priv', password: 'd09d09d09', auth:0, is_admin: true},
      {username: 'test', password: 'test', auth:1, is_admin: false},
      {username: 'demo_user', password: '123', auth:0, is_admin: false},
      ]
  ...
  @action initUsers() {
    ...
    this.users = [{username: 'admin', password: 'admin', auth:0, is_admin: true},...localUsers, ...this.users]
  }
}
